...
```sh
cd /Users/duoqilai/Documents/GitHub/asciinema

asciinema expect examples/05-a210-v2.sh \
  --output-dir 202607/board-compiler-test-cases_media/05-a210-v2 \
  --timeout 300 \
  --monitor
```
...
```text
202607/board-compiler-test-cases_media/序号-开发板脚本名/
```

例如：

```text
202607/board-compiler-test-cases_media/05-a210-v2/
├── 05-a210-v2.cast
├── 05-a210-v2.gif
├── 05-a210-v2.mp4
└── snapshots/
