# GCC and LLVM compiler test for the A210 SODIMM V2.
...
ruyi venv -t gnu-ruyisdk manual venv-gnu-ruyisdk-a210-sodimm-v2
#$ expect \$
. venv-gnu-ruyisdk-a210-sodimm-v2/bin/ruyi-activate
#$ expect \$
...
ruyi venv -t llvm-ruyisdk manual --sysroot-from gnu-ruyisdk venv-llvm-ruyisdk-a210-sodimm-v2
#$ expect \$
. venv-llvm-ruyisdk-a210-sodimm-v2/bin/ruyi-activate
#$ expect \$
clang -v
#$ expect \$
