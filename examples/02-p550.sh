# GCC and LLVM compiler test for SiFive HiFive Premier P550.
...
#$ expect \$
tio /dev/cu.usbserial-2102 -b 115200
#$ send \n
#$ expect \$
cat /proc/cpuinfo
#$ expect \$
...
cd coremark
#$ expect \$
make CC=riscv64-ruyisdk-linux-gnu-gcc XCFLAGS="-march=rv64imafdch_zicsr_zifencei_zca_zcd_zba_zbb" compile
#$ expect \$
