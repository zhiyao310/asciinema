# GCC and LLVM compiler test for Milk-V Megrez.
...
ruyi venv -t gnu-ruyisdk manual venv-gnu-ruyisdk-megrez
#$ expect \$
. venv-gnu-ruyisdk-megrez/bin/ruyi-activate
#$ expect \$
...
ruyi venv -t llvm-ruyisdk manual --sysroot-from gnu-ruyisdk venv-llvm-ruyisdk-megrez
#$ expect \$
. venv-llvm-ruyisdk-megrez/bin/ruyi-activate
#$ expect \$
clang -v
#$ expect \$
